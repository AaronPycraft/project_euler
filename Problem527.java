 ...
 * (initialized to L = 1 and H = n), let g = ⌊(L+H)/2⌋ where ⌊⋅⌋ 
 * is the integer floor function. If g = t, the process ends. Otherwise, 
 * if g < t, set L = g+1, but if g > t instead, set H = g−1. After setting
 * the new bounds, the search process repeats, and ultimately ends once t
 * is found. Even if t can be deduced without searching, assume that a
 ...
 * binary search. For example, B(6) = 2.33333333 and R(6) = 2.71666667 
